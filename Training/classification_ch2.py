...
np.save('./fold1_ch2.npy', confusion_matrix_list[0])
np.save('./fold2_ch2.npy', confusion_matrix_list[1])
np.save('./fold3_ch2.npy', confusion_matrix_list[2])
np.save('./fold4_ch2.npy', confusion_matrix_list[3])
np.save('./fold5_ch2.npy', confusion_matrix_list[4])