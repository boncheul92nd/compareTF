...
np.save('./fold1_ch2.npy', confusion_matrix_list[1])
np.save('./fold1_ch2.npy', confusion_matrix_list[2])
np.save('./fold1_ch2.npy', confusion_matrix_list[3])
np.save('./fold1_ch2.npy', confusion_matrix_list[4])