...
parser.add_argument('--datafolder', type=str, help='basename of folder where TFRecords are kept', default='res/Narrowband')
...
parser.add_argument('--model', type=str, help='load the model to train', default='conv3_ch2')
parser.add_argument('--freqbins', type=int, help='number of frequency bins in the spectrogram input', default=37)
parser.add_argument('--num_frames', type=int, help='number of frames in the spectrogram input (must divisible by 3)', default=50)
