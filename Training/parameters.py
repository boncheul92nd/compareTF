...
parser.add_argument('--num_frames', type=int, help='number of frames in the spectrogram input (must divisible by 3)', default=424)
parser.add_argument('--batchsize', type=int, help='number of data records per training batch', default=20)
parser.add_argument('--n_epochs', type=int, help='number of epochs to use for training', default=8)
parser.add_argument('--l1channels', type=int, help='number of channels in the first convolutional layer', default=24)
...
parser.add_argument('--fcsize', type=int, help='dimension of the final fully-connected layer', default=400)
