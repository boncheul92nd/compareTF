...
parser.add_argument('--freqbins', type=int, help='number of frequency bins in the spectrogram input', default=154)
parser.add_argument('--num_frames', type=int, help='number of frames in the spectrogram input (must divisible by 3)', default=12)
