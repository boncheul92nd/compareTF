...
#-----------------------------------------------
# For reading/writing single-channel tiff spectrogram in [a,b] frequency scale
# Also able to scale spectrogram to desired size
#-----------------------------------------------
...
def PNG2LogSpect(fname):
    ...
    minx, maxx, a, b = float(lwinfo['oldmin']), float(lwinfo['oldmax']), float(lwinfo['newmin']), float(
        lwinfo['newmax'])
